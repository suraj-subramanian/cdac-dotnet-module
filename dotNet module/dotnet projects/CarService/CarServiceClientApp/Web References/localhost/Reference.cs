...
namespace CarServiceClientApp.localhost {
    using System;
    ...
    public partial class CarService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public CarService() {
            this.Url = global::CarServiceClientApp.Properties.Settings.Default.CarServiceClientApp_localhost_CarService;
        ...
        public Car GetCar() {
            object[] results = this.Invoke("GetCar", new object[0]);
            return ((Car)(results[0]));
        }
        
        /// <remarks/>
        public void GetCarAsync() {
            this.GetCarAsync(null);
        }
        
        /// <remarks/>
        public void GetCarAsync(object userState) {
            ...
            this.InvokeAsync("GetCar", new object[0], this.GetCarOperationCompleted, userState);
        }
